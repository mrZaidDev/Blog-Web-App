...
const ReadMore = () => {
  ...
  return (
    ...
    <main className='m-auto md:max-w-[70%] sm:max-w-[100%]  h-screen p-10'>
     {!singlePost 
     ? <div className='text-center'><ClipLoader color="#000000" size={50} /></div>
     : <div>
       <h1 className='font-bold uppercase text-3xl lg:text-4xl'>{singlePost.title}</h1>
      <p className='text-[20px] text-gray-600 capitalize'>{singlePost.author.username}</p>
